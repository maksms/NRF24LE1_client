...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// unsigned char rf_read_rx_payload(unsigned char * dataptr, unsigned int len, bool transmit)
//
// Description:
//  Writes the payload to the TX FIFO
//
// Parameters:
//  unsigned char * dataptr	- pointer from which the payload data is read
//  unsigned int len - number of bytes to write to the payload
