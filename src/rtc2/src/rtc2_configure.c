...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// void rtc2_configure(unsigned char rtc2_config_options, unsigned int compare_value)
//
// Description:
//  Configures RTC2
//
// Parameters:
//  unsigned char rtc2_config_options - rtc2 configuration options
//  unsigned char compare_value - if using modes 2 or 3, this is the compare value
//
// Return value:
//  None
//
...
void rtc2_configure(unsigned char rtc2_config_options, unsigned int compare_value)
{
	...
	{
		RTC2CMP0 = (unsigned char)compare_value;
		RTC2CMP1 = (unsigned char)(compare_value >> 8);
	}
